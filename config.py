...
OUTPUT_DIR = "C:\\Users\\Mehmet_Postdoc\\Desktop\\python_set_up_code\\iterative_crowd_counting_with_confidence_curriculum_learning\\crowd_counting_outputs" # For logs, plots, models
...
# --- Curriculum Learning ("Focus on the Horizon") ---
CURRICULUM_SCHEDULE = [
    (0.0, 1.0),   
    (0.4, 1.0),   
    (0.7, 0.75),  
...
# --- Target Point Selection Skew ---
# Controls bias in selecting the target point for positive samples.
# 0.0 = uniform selection. > 0.0 biases towards points higher in the image (smaller y-coordinate).
# Higher values mean stronger bias.
TARGET_POINT_SELECTION_SKEW_POWER = 0.0 # Example: moderate bias towards points higher up
...
if CURRICULUM_SCHEDULE:
    print(f"Curriculum learning schedule enabled: {CURRICULUM_SCHEDULE}")
else:
    print("Curriculum learning schedule is not defined or empty (cropping will be uniform).")
print(f"Target point selection skew power: {TARGET_POINT_SELECTION_SKEW_POWER}")